...
@section('content')
  <div class="container" style="margin-bottom: 10px;">
    ...
    <table width="100%" style="margin-bottom: 5px; border: 1px solid black;">
      <tr>
        <td width="60%" style="background-color:black; color:white;"><h4>&nbsp;TECHNICAL REPORTss</h4></td>
    ...
    <table class="table borderless">
      <tr>
        ...
        <td>
          <b>Agreed By:</b>
          <br><br><br><br>
          [Customer Signature Over Printed Name]sss
        </td>
      </tr>
    </table>
      ...
      <div class="col-xs-12">
        <div class="panel panel-info">
          <div class="panel-body" align="center">
            <h3>{{ $technical->technician->company->company_name }}</h3>
