        ...
        <div class="col-md-12">
        	...
        	<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Job for Storing</h3>
				</div>
				<div class="panel-body">
					{!! Form::open(['method'=>'GET','url'=>route('job.storage'),'class'=>'form-horizontal','role'=>'search'])  !!}
			...
			{!! Form::open(['method'=>'POST', 'url'=>route('warehouse.store.job'), 'class'=>'form-horizontal', 'id'=>'form-assign-technician'])  !!}
			<table class="table">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group col-md-12 ">
						<div class="col-md-2">
							{!! Form::label('warehouse_id', 'Warehouses', array('class' => 'control-label')); !!}
						</div>
						<div class="col-md-8">
							{!! Form::select('warehouse_id', $warehouses, null, ['class' => 'form-control', 'required']); !!}
						</div>
						<div class="col-md-2">
			            	{!! Form::submit('Store Job', array('class' => 'btn btn-primary', 'id' => 'submitBtn')); !!}
			            </div>
			        </div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$( "select.job-action" ).change(function() {
		if( $(this).children(":selected").attr("id") == 'cancel-job' ) {
			/*var job_cancellation = confirm("{{trans('validation.confirm_job_cancellation')}}");

			if (job_cancellation == true) {
				//location.href = $( "select.job-action" ).val();
