			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						{{--<td>
							<a href="{{ route('warehouse.edit', $warehouse->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;
							@can('delete_warehouse')
							{!! Form::model($warehouse, array('method' => 'delete', 'route' => ['warehouse.destroy', $warehouse->id], 'id' => 'delete_warehouse_'.$warehouse->id, 'style' => 'display:inline')) !!}
